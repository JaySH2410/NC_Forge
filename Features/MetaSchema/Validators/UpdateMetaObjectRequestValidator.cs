...
public sealed class UpdateMetaObjectRequestValidator
    : AbstractValidator<UpdateMetaObjectRequest>
{
    public UpdateMetaObjectRequestValidator()
    {
        RuleFor(x => x.Uuid)
            .NotEmpty()
        ...
        RuleFor(x => x.VersionIncrement)
            .IsInEnum()
            .WithMessage("VersionIncrement must be Minor or Major.");
    }
}
